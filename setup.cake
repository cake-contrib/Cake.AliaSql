...
var solutionFilePath          = "./src/Cake.AliaSql.sln";
var solutionDirectoryPath     = "./src/Cake.AliaSql";
var title                     = "Cake.AliaSql";
var resharperSettingsFileName = "Cake.AliaSql.sln.DotSettings";
var repositoryOwner           = "cake-contrib";
var repositoryName            = "Cake.AliaSql";
var appVeyorAccountName       = "cakecontrib";
var appVeyorProjectSlug       = "cake-aliasql";

// NOTE: Only populate this, if required, but leave as is otherwise.
var dupFinderExcludePattern   = new string[] { rootDirectoryPath + "/src/Cake.AliaSql.Tests/*.cs" };
